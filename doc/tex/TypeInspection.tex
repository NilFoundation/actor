...
is not serializable causes a compiler error \see{unsafe-message-type}. ACTOR
...
% TODO: expand example here\cppexample[linerange={50-54}]{../../core/caf/allowed_unsafe_message_type.hpp}
