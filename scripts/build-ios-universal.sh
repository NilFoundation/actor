...
lipo -create \
    ${IPHONEOS_BUILD_DIR}/bin/Debug/core_static.a \
    ${IPHONESIMULATOR_BUILD_DIR}/bin/Debug/core_static.a \
    -output ${PREFIX}/lib/Debug/core_static.a
lipo -create \
    ${IPHONEOS_BUILD_DIR}/bin/Debug/io_static.a \
    ${IPHONESIMULATOR_BUILD_DIR}/bin/Debug/io_static.a \
    -output ${PREFIX}/lib/Debug/io_static.a

mkdir -p ${PREFIX}/lib/Release
lipo -create \
    ${IPHONEOS_BUILD_DIR}/bin/Release/core_static.a \
    ${IPHONESIMULATOR_BUILD_DIR}/bin/Release/core_static.a \
    -output ${PREFIX}/lib/Release/core_static.a
lipo -create \
    ${IPHONEOS_BUILD_DIR}/bin/Release/io_static.a \
    ${IPHONESIMULATOR_BUILD_DIR}/bin/Release/io_static.a \
    -output ${PREFIX}/lib/Release/io_static.a
