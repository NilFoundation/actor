        ...
        namespace intrusive {
            ...
            public:
                ...
                inbox_result push_front(pointer new_element) noexcept {
                    MTL_ASSERT(new_element != nullptr);
                ...
                pointer take_head(pointer new_head) noexcept {
                    ...
                    // empty.
                    MTL_ASSERT(new_head == stack_closed_tag() || new_head == stack_empty_tag());
                    pointer e = stack_.load();
                    // Must not be called on a closed queue.
                    MTL_ASSERT(e != stack_closed_tag());
                    ...
                    MTL_ASSERT(e != reader_blocked_tag() || new_head == stack_closed_tag());
                    ...
                    while (e != new_head) {
                        if (stack_.compare_exchange_weak(e, new_head)) {
                            ...
                            if (is_empty_or_blocked_tag(e)) {
                                ...
                                MTL_ASSERT(new_head == stack_closed_tag());
                                return nullptr;
                            }
                            return e;
                        }
