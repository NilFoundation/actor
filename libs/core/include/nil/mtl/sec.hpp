...
namespace nil {
    namespace mtl {
        ...
        enum class sec : uint8_t {
            ...
            /// A remote node disconnected during MTL handshake.
            ...
            /// User requested to close port 0 or to close a port not managed by MTL.
            ...
            end_of_stream,
            /// Serialization failed because no MTL context is available.
            no_context = 25,
            /// Serialization failed because MTL misses run-time type information.
            unknown_type,
