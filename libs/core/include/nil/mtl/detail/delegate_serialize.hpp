...
// - MTL does *not* respect class versions
// - the `unsigned int` argument is always 0 and ignored by MTL
//
// Since MTL requires all runtime instances to have the same types
...
namespace nil {
    namespace mtl {
        namespace detail {
            ...
            // Calls `serialize(...)` without the unused version argument, which MTL
            // ignores anyway.
