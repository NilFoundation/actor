...
#include <nil/mtl/detail/variant_data.hpp>

#define MTL_VARIANT_CASE(n) \
    case n:                 \
        return f(std::forward<Us>(xs)..., x.get(std::integral_constant<int, (n <= max_type_id ? n : 0)>()))

#define MTL_VARIANT_ASSIGN_CASE(n)                                                                         \
    case n: {                                                                                              \
    ...
    namespace mtl {
        ...
        public:
            ...
            static Result apply_impl(Self &x, Visitor &&f, Us &&... xs) {
                switch (x.type_) {
                    default:
                        MTL_RAISE_ERROR("invalid type found");
                        MTL_VARIANT_CASE(0);
                        MTL_VARIANT_CASE(1);
                        MTL_VARIANT_CASE(2);
                        MTL_VARIANT_CASE(3);
        ...
        typename Inspector::result_type inspect(Inspector &f, variant_writer<variant<Ts...>> &x) {
            switch (x.type_tag) {
                default:
                    MTL_RAISE_ERROR("invalid type found");
                    MTL_VARIANT_ASSIGN_CASE(0);
                    MTL_VARIANT_ASSIGN_CASE(1);
                    MTL_VARIANT_ASSIGN_CASE(2);
                    MTL_VARIANT_ASSIGN_CASE(3);
                    MTL_VARIANT_ASSIGN_CASE(4);
                    MTL_VARIANT_ASSIGN_CASE(5);
                    MTL_VARIANT_ASSIGN_CASE(6);
                    MTL_VARIANT_ASSIGN_CASE(7);
                    MTL_VARIANT_ASSIGN_CASE(8);
                    MTL_VARIANT_ASSIGN_CASE(9);
                    MTL_VARIANT_ASSIGN_CASE(10);
                    MTL_VARIANT_ASSIGN_CASE(11);
                    MTL_VARIANT_ASSIGN_CASE(12);
                    MTL_VARIANT_ASSIGN_CASE(13);
                    MTL_VARIANT_ASSIGN_CASE(14);
                    MTL_VARIANT_ASSIGN_CASE(15);
                    MTL_VARIANT_ASSIGN_CASE(16);
                    MTL_VARIANT_ASSIGN_CASE(17);
                    MTL_VARIANT_ASSIGN_CASE(18);
                    MTL_VARIANT_ASSIGN_CASE(19);
            }
        }
