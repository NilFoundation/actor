    ...
    namespace mtl {
        ...
        public:
            ...
            template<class Container,
                     class = typename std::enable_if<detail::has_data_member<Container>::value &&
                                                     detail::has_size_member<Container>::value>::type>
            arraybuf(Container &c) : arraybuf(const_cast<char_type *>(c.data()), c.size()) {
                // nop
            }
        ...
        protected:
            ...
            std::streamsize xsputn(const char_type *s, std::streamsize n) override {
                ...
                std::memcpy(this->pptr(), s, static_cast<size_t>(actual) * sizeof(char_type));
            ...
            std::streamsize xsgetn(char_type *s, std::streamsize n) override {
                ...
                auto actual = std::min(n, static_cast<std::streamsize>(available));
                std::memcpy(s, this->gptr(), static_cast<size_t>(actual) * sizeof(char_type));
        ...
        template<class Container>
        class containerbuf
            : public stream_buffer<typename Container::value_type, std::char_traits<typename Container::value_type>> {
        public:
            using base =
                std::basic_streambuf<typename Container::value_type, std::char_traits<typename Container::value_type>>;
            using char_type = typename base::char_type;
            using traits_type = typename base::traits_type;
            using int_type = typename base::int_type;
            using pos_type = typename base::pos_type;
            ...
            template<class C = Container,
                     class = typename std::enable_if<detail::has_data_member<C>::value &&
