        ...
        namespace opencl {
            ...
            public:
                ...
                mem_ref<T> global_argument(const std::vector<T> &data, cl_mem_flags flags = buffer_type::input_output,
                    ...
                    auto buffer = v2get(MTL_CLF(clCreateBuffer), context_.get(), flags, buffer_size, nullptr);
                    detail::raw_event_ptr event {v1get<cl_event>(MTL_CLF(clEnqueueWriteBuffer), queue_.get(), buffer,
                ...
                mem_ref<T> scratch_argument(size_t size, cl_mem_flags flags = buffer_type::scratch_space) {
                    auto buffer = v2get(MTL_CLF(clCreateBuffer), context_.get(), flags, sizeof(T) * size, nullptr);
                ...
                expected<mem_ref<T>> copy(mem_ref<T> &mem) {
                    ...
                    cl_event event;
                    auto buffer = v2get(MTL_CLF(clCreateBuffer), context_.get(), mem.access(), buffer_size, nullptr);
