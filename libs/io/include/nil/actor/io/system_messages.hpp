    ...
    namespace actor {
        namespace io {
            ...
            typename Inspector::result_type inspect(Inspector &f, new_data_msg &x) {
                return f(meta::type_name("new_data_msg"), x.handle, meta::hex_formatted(), x.buf);
            }
            ...
            typename Inspector::result_type inspect(Inspector &f, data_transferred_msg &x) {
                return f(meta::type_name("data_transferred_msg"), x.handle, x.written, x.remaining);
            }
            ...
            template<class Inspector>
            typename Inspector::result_type inspect(Inspector &f, connection_passivated_msg &x) {
            ...
            template<class Inspector>
            typename Inspector::result_type inspect(Inspector &f, acceptor_passivated_msg &x) {
            ...
            template<class Inspector>
            typename Inspector::result_type inspect(Inspector &f, datagram_servant_passivated_msg &x) {
            ...
            template<class Inspector>
            typename Inspector::result_type inspect(Inspector &f, datagram_servant_closed_msg &x) {
