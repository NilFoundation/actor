...
namespace nil {
    namespace actor {
        namespace io {
            ...
            ///   -> (uint16_t)
            ///
            ///   // Opens a new port other ACTOR instances can connect to. The
            ...
            using middleman_actor = typed_actor<
                replies_to<publish_atom, uint16_t, strong_actor_ptr, std::set<std::string>, std::string,
                           bool>::with<uint16_t>,

                replies_to<open_atom, uint16_t, std::string, bool>::with<uint16_t>,

                replies_to<connect_atom, std::string, uint16_t>::with<node_id, strong_actor_ptr, std::set<std::string>>,
