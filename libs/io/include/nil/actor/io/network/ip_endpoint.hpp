        ...
        namespace io {
            namespace network {
                ...
                typename Inspector::result_type inspect(Inspector &fun, ip_endpoint &ep) {
                    ...
                    return fun(meta::type_name("ip_endpoint"), f, h, p, l, meta::load_callback(load),
...
namespace std {
    template<>
    struct hash<nil::actor::io::network::ip_endpoint> {
        using argument_type = nil::actor::io::network::ip_endpoint;
        using result_type = size_t;
        result_type operator()(const argument_type &ep) const {
            auto ptr = ep.caddress();
            return nil::actor::io::network::ep_hash {}(*ptr);
        }
    };
}    // namespace std
