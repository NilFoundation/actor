    ...
    namespace actor {
        namespace io {
            namespace network {
                ...
                receive_buffer::receive_buffer() noexcept : buffer_(nullptr), capacity_(0), size_(0) {
                    // nop
                }
                ...
                receive_buffer::receive_buffer(receive_buffer &&other) noexcept : receive_buffer() {
                    swap(other);
                }

                receive_buffer::receive_buffer(const receive_buffer &other) : receive_buffer(other.size()) {
